// Verse data — ESV text, organized into collections.
// Each verse: id, ref, date, theme, text, collection.
...
// Mastery state (mock). 'mastered' | 'learning' | 'new'
const MASTERY = {
  'ps119-11': 'mastered', 'ps19-14': 'mastered', 'col3-12': 'mastered', '2co5-17': 'mastered',
  '1jn4-4': 'mastered', 'ps27-1': 'mastered', 'isa41-10': 'mastered', 'jer29-11': 'mastered',
  'rom6-6': 'mastered', 'rom8-1': 'mastered', 'gal5-1': 'mastered', '1pe2-1': 'mastered',
  'jn8-36': 'mastered', 'col1-13': 'mastered',
  'ps37-30': 'learning', '2ti1-7': 'learning',
  'ps23-4': 'learning',
  'jn8-31': 'new', 'php4-6': 'new', '1th5-16': 'new', '2co1-3': 'new',
  'ps139-7': 'new', 'isa43-2': 'new', 'heb13-5': 'new',
};

const COLLECTIONS = [
  { id: 'foundation', name: 'Foundation', subtitle: 'Jan — Feb',      hueShift: 0 },
  { id: 'freedom',    name: 'Freedom',    subtitle: 'Mar — Apr',      hueShift: 32 },
  { id: 'presence',   name: 'God\u2019s Presence', subtitle: 'Apr — Jun', hueShift: -24 },
];

Object.assign(window, { VERSES, MASTERY, COLLECTIONS });
